...
function efline_icon( $name, $attrs = array() ) {
	...
	$icons = array(
		...
		'external' => '<svg' . $attr_str . ' viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.8" stroke-linecap="round" stroke-linejoin="round"><path d="M18 13v6a2 2 0 0 1-2 2H5a2 2 0 0 1-2-2V8a2 2 0 0 1 2-2h6"/><polyline points="15 3 21 3 21 9"/><line x1="10" y1="14" x2="21" y2="3"/></svg>',
		'tooth-outline' => '<svg' . $attr_str . ' viewBox="0 0 32 32" fill="none" stroke="currentColor" stroke-width="1.8" stroke-linecap="round" stroke-linejoin="round"><path d="M16 4c-3 0-5 1-8 1-1.5 0-2.5 1.2-2.5 3 0 4 1.5 7 2.5 10.5.7 2.7 1.2 6 2 8 .5 1.2 1.5 1.5 2.2.5.8-1.2 1.6-4.8 2.3-6 .7-1.2 1.4-1.2 2 0 .5 1.2 1.4 4.8 2.2 6 .7 1 1.7.7 2.2-.5.8-2 1.3-5.3 2-8 1-3.5 2.5-6.5 2.5-10.5 0-1.8-1-3-2.5-3-2.5 0-4.5-1-5-1z"/></svg>',
		'sparkle-tooth' => '<svg' . $attr_str . ' viewBox="0 0 32 32" fill="none" stroke="currentColor" stroke-width="1.8" stroke-linecap="round" stroke-linejoin="round"><path d="M14 5c-2.5 0-4 1-6.5 1-1.3 0-2 1.1-2 2.6 0 3.5 1.3 6 2.2 9.2.6 2.3 1 5.2 1.7 7 .5 1 1.4 1.3 2 .4.7-1 1.4-4.2 2-5.3.6-1 1.2-1 1.6 0 .4 1.1 1.2 4.3 1.9 5.3.6 1 1.5.6 2-.4.7-1.8 1.1-4.7 1.7-7 .9-3.2 2.2-5.7 2.2-9.2 0-1.5-.8-2.6-2-2.6-2 0-3.6-1-4.6-1z"/><path d="M25 6l.8 2L28 9l-2.2.8L25 12l-1-2-2-1 2-.8z"/><path d="M28 13l.5 1.4L30 15l-1.5.5L28 17l-.5-1.5L26 15l1.5-.6z"/></svg>',
	);
