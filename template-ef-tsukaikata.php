 ...
 * テンプレ直書き、画像は picsum.photos プレースホルダ。
 *
 * @package efline
 */
get_header();
		...
		<ol class="p-ef-steps">
			<li class="p-ef-steps__item">
				...
				<figure class="p-ef-steps__image">
					<img src="https://picsum.photos/seed/efstep1/300/200" alt="" loading="lazy">
				</figure>
			</li>
			<li class="p-ef-steps__item">
				...
				<figure class="p-ef-steps__image">
					<img src="https://picsum.photos/seed/efstep2/300/200" alt="" loading="lazy">
				</figure>
			</li>
			<li class="p-ef-steps__item">
				...
				<figure class="p-ef-steps__image">
					<img src="https://picsum.photos/seed/efstep3/300/200" alt="" loading="lazy">
				</figure>
			</li>
			<li class="p-ef-steps__item">
				...
				<figure class="p-ef-steps__image">
					<img src="https://picsum.photos/seed/efstep4/300/200" alt="" loading="lazy">
				</figure>
			</li>
		</ol>
	</section>
